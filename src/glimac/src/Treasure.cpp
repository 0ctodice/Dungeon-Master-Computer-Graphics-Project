...
namespace glimac
{
    Treasure::Treasure(int id, glm::vec2 pos, int lvl, std::string name, int type, int value, std::string texture) : Entity{id, pos, lvl, name, texture}, type{static_cast<TreasureType>(type)}, value{value} {}
